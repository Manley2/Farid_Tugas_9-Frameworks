...
Buat file registration_process.php kemudian terapkan kode HTML+PHP di bawah ini.
...
<body>
    ...
    <fieldset style="width: 600px;">
        ...
        <table>
            <tr>
                <td>
                    <input type="checkbox" name="student_skill_html" value="html" id="html" <?= $student_skill_html
